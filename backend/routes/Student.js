...
router.post('/', middlewareUser.verifyToken, middlewareUser.verifyTokenAndAdminUser, MiddlewareStudent.handleUpload, studentController.createStudent)
router.put('/', middlewareUser.verifyToken, middlewareUser.verifyTokenAndAdminUser, MiddlewareStudent.handleUpload, studentController.updateStudent)
